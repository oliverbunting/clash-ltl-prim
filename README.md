...
- [Project overview](#project-overview)
  - [clash-ltl-prim.cabal](#namecabal)
...
Note: If you need a newer Clash version, simply change the version bounds in `clash-ltl-prim.cabal` and follow the hints given by Stack.

## src/
This is where the source code of the project lives, as specified in `clash-ltl-prim.cabal`. It contains a single file, `Example/Project.hs` which starts with:
...
# Change the license
By default `clash-ltl-prim.cabal` sets its `license` field to `BSD-2-Clause`. You might want to change this.
